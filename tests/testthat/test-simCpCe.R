...
context("simCpCe")
source(file.path("..","..", "globalPackages.R"))
print(getwd())
print(list.files())
source(file.path("..","..", "helpers", "simCpCe.R"))
source(file.path("..","..", "helpers", "advanceClosedForm0.R"))
source(file.path("..","..", "helpers", "advanceState.R"))
...
test_that("it returns the correct array", {
  ...
  events <- data.table( Time = double(), Event = character(), Fill = character())
  ...
  expected <- list(
    results <- data.frame(
      ...
      Time = c(0.0000000, 0.3927912, 0.4798367, 0.5861721, 0.7160723, 0.8747594, 1.0686127, 1.3054254, 1.5947176, 1.9481192, 2.3798372, 2.9072272, 3.5514909, 4.3385282, 5.2999791, 6.4744947, 7.9092920, 9.6620512, 11.8032352, 14.4189218, 17.6142645, 21.5177194, 26.2862095, 32.1114334, 39.2275711, 47.9206990, 58.5402901, 60.0000000, 0.0000000, 0.3927912, 0.4798367, 0.5861721, 0.7160723, 0.8747594, 1.0686127, 1.3054254, 1.5947176, 1.9481192, 2.3798372, 2.9072272, 3.5514909, 4.3385282, 5.2999791, 6.4744947, 7.9092920, 9.6620512, 11.8032352, 14.4189218, 17.6142645, 21.5177194, 26.2862095, 32.1114334, 39.2275711, 47.9206990, 58.5402901, 60.0000000, 0.0000000, 0.3927912, 0.4798367, 0.5861721, 0.7160723, 0.8747594, 1.0686127, 1.3054254, 1.5947176, 1.9481192, 2.3798372, 2.9072272, 3.5514909, 4.3385282, 5.2999791, 6.4744947, 7.9092920, 9.6620512, 11.8032352, 14.4189218, 17.6142645, 21.5177194, 26.2862095, 32.1114334, 39.2275711, 47.9206990, 58.5402901, 60.0000000, 0.0000000, 0.3927912, 0.4798367, 0.5861721, 0.7160723, 0.8747594, 1.0686127, 1.3054254, 1.5947176, 1.9481192, 2.3798372, 2.9072272, 3.5514909, 4.3385282, 5.2999791, 6.4744947, 7.9092920, 9.6620512, 11.8032352, 14.4189218, 17.6142645, 21.5177194, 26.2862095, 32.1114334, 39.2275711, 47.9206990, 58.5402901, 60.0000000, 0.0000000, 0.3927912, 0.4798367, 0.5861721, 0.7160723, 0.8747594, 1.0686127, 1.3054254, 1.5947176, 1.9481192, 2.3798372, 2.9072272, 3.5514909, 4.3385282, 5.2999791, 6.4744947, 7.9092920, 9.6620512, 11.8032352, 14.4189218, 17.6142645, 21.5177194, 26.2862095, 32.1114334, 39.2275711, 47.9206990, 58.5402901, 60.0000000, 0.0000000, 0.3927912, 0.4798367, 0.5861721, 0.7160723, 0.8747594, 1.0686127, 1.3054254, 1.5947176, 1.9481192, 2.3798372, 2.9072272, 3.5514909, 4.3385282, 5.2999791, 6.4744947, 7.9092920, 9.6620512, 11.8032352, 14.4189218, 17.6142645, 21.5177194, 26.2862095, 32.1114334, 39.2275711, 47.9206990, 58.5402901, 60.0000000),
  ...
  expect_equal(actual$results, expected$results)
  expect_equal(actual$max, expected$max)
})
